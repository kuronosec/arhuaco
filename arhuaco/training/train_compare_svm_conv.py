...
def main(argv):
    try:
       ...
       print("test_compare_svm_conv -t <type>")
       sys.exit(2)
    for opt, arg in opts:
       if opt == '-h':
          print("test_compare_svm_conv -t <type>")
...
def analyze_syscalls():
    ...
    plot.history2plot([history_conv.history['val_real_accuracy'],
                       history_svm.history['val_real_accuracy']],
                       ['CNN', 'SVM'],
    ...
    plot.history2plot([history_conv.history['val_false_pos_rate'],

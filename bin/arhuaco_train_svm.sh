...
# nohup $PYTHON_COMMAND "$ARHUACO_LOCATION"/training/train_svm_bow.py -t $1 </dev/null >/var/log/arhuaco/output.log 2>&1 &
nohup $PYTHON_COMMAND "$ARHUACO_LOCATION"/training/train_svm_w2v.py -t $1 </dev/null >/var/log/arhuaco/output.log 2>&1 &
# $PYTHON_COMMAND "$ARHUACO_LOCATION"/training/train_svm_bow.py -t $1
